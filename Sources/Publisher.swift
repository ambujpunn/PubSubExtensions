...
public extension Publisher where Self.Failure == Never {
    func sink(demand: Subscribers.Demand, receivedValue: @escaping Subscribers.ReceivedValue<Self.Output>) -> AnyCancellable {
...
public extension Publisher {
    func sink(demand: Subscribers.Demand, receivedCompletion: @escaping Subscribers.ReceivedCompletion<Self.Failure>,
